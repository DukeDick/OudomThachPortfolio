        ...
        <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
          ...
          <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
            ...
            <Details
              ...
              company="Le Lézard Bleu"
              time="January 2015-January 2018"
              address="Phnom Penh, Cambodia"
              work="Translated documents and assisted staff with communication needs. Conducted research on souvenir frames and contacted buyers to source wooden frames. Helped staff interact with foreign customers, ensuring a smooth customer experience and clear communication."
            />
